...
public class FieldLayout {
	...
	public static boolean nearMark(Pose2d pose) {
		return Util.epsilonEquals(
						pose.getTranslation(),
						FieldLayout.handleAllianceFlip(blueLeftMark, Robot.isRed()),
						Units.Feet.of(3.0))
				|| Util.epsilonEquals(
						pose.getTranslation(),
						FieldLayout.handleAllianceFlip(blueMidMark, Robot.isRed()),
						Units.Feet.of(3.0))
				|| Util.epsilonEquals(
						pose.getTranslation(),
						FieldLayout.handleAllianceFlip(blueRightMark, Robot.isRed()),
						Units.Feet.of(3.0));
	}
