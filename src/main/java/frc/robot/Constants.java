...
public final class Constants {
  ...
  public class Elevator {
    ...
    /* CANBus */
    public static final String canBus = "rio"; //TODO: determine to run this either on the RIO loop or a seperate CANivore
    /* Motor Config Values */
    public static final double peakForwardVoltage = 13.5;
    public static final double peakReverseVoltage = -13.5;
    ...
    public static final double kV = 1.0; // output per unit of target velocity (output/rps)
